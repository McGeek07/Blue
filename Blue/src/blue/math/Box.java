		...
		protected static final <B extends Box2> B fromString(B b, String s) {
			if(b != null && s != null) {
		        ...
		        switch (t.length) {
		            default:
		            case 4:
		            	b.v1.y = StringUtility.stringToFloat(t[3]);
		            case 3:
		            	b.v1.x = StringUtility.stringToFloat(t[2]);
		            case 2:
		                b.v0.y = StringUtility.stringToFloat(t[1]);
		            case 1:
		                b.v0.x = StringUtility.stringToFloat(t[0]);
		            case 0:
		        }
			}	        
	        return b;
		...
		protected static final <B extends Box3> B fromString(B b, String s) {
			if(b != null && s != null) {
		        ...
		        switch (t.length) {
		            default:
		            case 6:
		            	b.v1.z = StringUtility.stringToFloat(t[5]);
		            case 5:
		            	b.v1.y = StringUtility.stringToFloat(t[4]);
		            case 4:
		            	b.v1.x = StringUtility.stringToFloat(t[3]);
		            case 3:
		            	b.v0.z = StringUtility.stringToFloat(t[2]);
		            case 2:
		                b.v0.y = StringUtility.stringToFloat(t[1]);
		            case 1:
		                b.v0.x = StringUtility.stringToFloat(t[0]);
